...
ONLY SELECT CRITERIA WHICH EXPLICITLY MENTION FOR reauthorization, renewal, continuation approval, or continuation of therapy or terms which imply similar meaning. Look for requirements such as continued clinical benefit, continued positive response, low disease activity, improvement in signs or symptoms, lack of disease progression, required lab values, or updated clinical documentation.
